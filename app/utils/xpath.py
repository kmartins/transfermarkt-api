class Players:
    ...
    class Profile:
        ...
        ON_LOAN_FROM_NAME = "//span[contains(text(),'On loan from:')]//following::span[1]//text()"
        ON_LOAN_FROM_URL = "//span[contains(text(),'On loan from:')]//following::span[1]//a//@href"
        ON_LOAN_FROM_CONTRACT_EXPIRES = "//span[contains(text(),'Contract there expires')]//following::span[1]//text()"
